...
public class FileTask {
    ...
    public static void writeToFile(Scanner scanner) {
        ...
        try (FileWriter fileWriter = new FileWriter("src/Project13/Proverka.txt");
            ...
            System.out.println("Data has been successfully written to 'Proverka.txt'");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void readFromFile() {
        try (FileReader fileReader = new FileReader("src/Project13/Proverka.txt");
    ...
    public static void replaceInFile(Scanner scanner) {
        ...
        try (FileReader fileReader = new FileReader("src/Project13/Proverka.txt");
            ...
            try (FileWriter fileWriter = new FileWriter("src/Project13/Proverka.txt");
                ...
                System.out.println("Information has been successfully replaced in 'Proverka.txt'");
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    public static void appendToFile(Scanner scanner) {
        ...
        try (FileWriter fileWriter = new FileWriter("src/Project13/Proverka.txt", true);
             BufferedWriter bufferedWriter = new BufferedWriter(fileWriter)) {
            ...
            System.out.println("Data has been successfully appended to 'Proverka.txt'");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
